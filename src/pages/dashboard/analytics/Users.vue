    ...
    <div class="col-12 col-xl-6">
        <div class="card rounded-3 overflow-hidden mb-3">
            ...
            <div class="card-body position-relative">
                ...
                <div id="users-time-series-chart" style="height: 300px;">
    ...
    <div class="col-12 col-xl-6">
        <div class="card rounded-3 overflow-hidden mb-3">
            ...
            <div class="card-body position-relative">
                ...
                <div id="users-cumulative-chart" style="height: 300px;">
...
const dataset = (period: Period, frequency: Frequency, cumulative = false) => {
    ...
    let set = new ChartAid(period, frequency).getDataset(store.users_time_series)
